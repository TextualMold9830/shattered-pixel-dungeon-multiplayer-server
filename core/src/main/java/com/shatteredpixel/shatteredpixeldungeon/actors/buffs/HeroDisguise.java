...
public class HeroDisguise extends FlavourBuff {
	...
	public void fx(boolean on) {
		if (target instanceof Hero && target.getSprite() instanceof HeroSprite){
			if (cls == null) {
				do {
			...
			if (on) ((HeroSprite) target.getSprite()).disguise(cls);
			else    ((HeroSprite) target.getSprite()).disguise(((Hero) target).heroClass);
